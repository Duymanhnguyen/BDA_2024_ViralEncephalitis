...
FalseDiscoveryCorrection <- function(NumberOfNAs,
  ...
  # Filter the ordered results by Log2FC threshold at 0.2
  metaOutputFDR_OrderbyPval_Log2FC_0.2 <- metaOutputFDR_annotated %>%
    filter(abs(Log2FC_estimate) >= 0.2) %>%
    arrange(pval)
  
  # Filter the ordered results by Log2FC threshold at 1
  metaOutputFDR_OrderbyPval_Log2FC_1.0 <- metaOutputFDR_annotated %>%
  ...
  # Export the ordered, annotated, filtered results at Log2FC of 0.2
  write.csv(metaOutputFDR_OrderbyPval_Log2FC_0.2, 
            paste("metaOutputFDR_OrderedByPval_Log2FC_0.2_", NumberOfNAs, "NA.csv",sep = ""), 
            row.names = FALSE)
  
  # Export the ordered, annotated, filtered results at Log2FC of 1
  write.csv(metaOutputFDR_OrderbyPval_Log2FC_1.0, 
            paste("metaOutputFDR_OrderedByPval_Log2FC_1.0_", NumberOfNAs, "NA.csv",sep = ""), 
            row.names = FALSE)
  ...
  print("# of genes that are statistically significant following traditional FDR correction (FDR < 0.05) and |Log2FC| > 0.2 :")
  print(sum(metaOutputFDR_OrderbyPval_Log2FC_0.2$FDR < 0.05, na.rm = TRUE))
  
  print("# of genes that are statistically significant following traditional FDR correction (FDR < 0.05) and |Log2FC| > 1 :")
  print(sum(metaOutputFDR_OrderbyPval_Log2FC_1.0$FDR < 0.05, na.rm = TRUE))
  ...
  # Print top results in mouse genes with |Log2FC| >= 0.2
  print("Top 20 results ordered by p-values in mouse genes with |Log2FC| >= 0.2:")
  print(head(metaOutputFDR_OrderbyPval_Log2FC_0.2$Mouse_Symbol, 20))
  
  # Print top results in rat genes with |Log2FC| >= 0.2
  print("Top 20 results ordered by p-values in rat genes with |Log2FC| >= 0.2:")
  print(head(metaOutputFDR_OrderbyPval_Log2FC_0.2$Rat_Symbol, 20))
  
  # Print top results in mouse genes with |Log2FC| >= 1
  print("Top 20 results ordered by p-values in mouse genes with |Log2FC| >= 1:")
  print(head(metaOutputFDR_OrderbyPval_Log2FC_1.0$Mouse_Symbol, 20))
  
  # Print top results in rat genes with |Log2FC| >= 1
  print("Top 20 results ordered by p-values in rat genes with |Log2FC| >= 1:")
  print(head(metaOutputFDR_OrderbyPval_Log2FC_1.0$Rat_Symbol, 20))
  ...
  return(list(metaOutputFDR = metaOutputFDR,
              ...
              metaOutputFDR_OrderbyPval_Log2FC_0.2 = metaOutputFDR_OrderbyPval_Log2FC_0.2,
              metaOutputFDR_OrderbyPval_Log2FC_1.0 = metaOutputFDR_OrderbyPval_Log2FC_1.0,
...
# Meta-analysis with FDR output ordered by p-values filtered by Log2FC at 0.2
metaOutputFDR_OrderbyPval_Log2FC_0.2_0NA <- metaOutputFDR_all_0NA[[4]]

# Meta-analysis with FDR output ordered by p-values filtered by Log2FC at 1
metaOutputFDR_OrderbyPval_Log2FC_1.0_0NA <- metaOutputFDR_all_0NA[[5]]
